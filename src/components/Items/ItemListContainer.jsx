...
const ItemListContainer = () => {
    ...
    useEffect(() => {
        ...
        // getProducts()
        // setClickedCategory();
    }, [category, productsArray, allProducts]);
    ...
    const getProducts = () => {
        let search = document
            ...
            .value.toLowerCase()
            .trim();
        const productsSearched = allProducts.filter((product) =>
            product.name.toLowerCase().includes(search.toLowerCase())
        );

        if (category) {
            const productsFiltered = productsSearched.filter(
        ...
        <div className="products">
            <div className="categoryFilter">
                ...
                <div className="filter">
                    ...
                    <Link to="/products/cápsula">
                        <button className="cápsula">Cápsula</button>
                    </Link>
                    <Link to="/products/elementos">
                        <button className="elementos">Elementos</button>
                    </Link>
                    <Link to="/products/café-molido">
                        <button className="café-molido">Café molido</button>
                    </Link>
                </div>
            </div>
